package com.example.mylistgridfruits.adapters;
...
public class FruitAdapter extends BaseAdapter {//extender de la clase BaseAdapter y sobreescribir metodos para nuestro obj

    private Context context;
    private int layout;
    private List<Fruit> list;

    public FruitAdapter(Context context, int layout, List<Fruit> list){//default constructor
    ...
    //renombramos los metodos getters and setters para nuestro objeto
    @Override
    public int getCount() {
        return list.size();
    }
